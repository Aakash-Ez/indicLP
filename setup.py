...
setup(
  ...
  version = '0.0.1x',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Aakash-Ez/indicLP/archive/refs/tags/stable.tar.gz',    # I explain this later on
